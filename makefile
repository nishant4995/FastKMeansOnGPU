...
ifeq ($(TARGET_OS),darwin)
  $(info >>> WARNING - cudaOpenMP is not supported on Mac OSX - waiving sample <<<)
  SAMPLE_ENABLED := 0
endif
...
# Gencode arguments For different versions of compute capability, Compute capability of my card is 5.0
